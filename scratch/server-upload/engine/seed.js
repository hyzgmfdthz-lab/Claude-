...
export function seedProjects() {
  ...
  return avErledigt([
    ...
    P({ id: 'PRJ-WGC40S00', orderNo: 'WGC40-S00%%%', customer: "Infraserv", name: "Infraserv WGC40-S00%%%", projectType: 'WKP', variant: 'FT40', dueDate: '2027-02-01', handoverDate: '2026-10-18', priority: 'P3', sequence: 230, operations: [{ opId: 'SAEGEN', status: 'X' }, { opId: 'ENTGRATEN', status: 'X' }, { opId: 'BIEGEN', status: 'X' }, { opId: 'HEFTEN', status: 'X' }, { opId: 'ORBITAL_KEHLNAHT', plannedHours: 10 }, { opId: 'ORBITAL_STUMPFNAHT', plannedHours: 20 }, { opId: 'BEIZEN', plannedHours: 4 }, { opId: 'VORMONTAGE', status: 'X' }, { opId: 'HYDRO', plannedHours: 17 }, { opId: 'ENDKONTROLLE', plannedHours: 12 }, { opId: 'REINIGEN', plannedHours: 7.5 }], totalHoursOverride: null }),  // P23
